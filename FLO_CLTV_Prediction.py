...
# sağlayacakları potansiyel değerin
...
# geçmiş alışveriş davranışlarından
...
df_ = pd.read_csv(r"C:\Users\NUR\Desktop\DTS02\VBO_17\flo_data_20k.csv")
df = df_.copy()
df.head()
df.shape


# 2. Aykırı değerleri baskılamak için gerekli olan outlier_thresholds ve replace_with_thresholds
...
# Aykırı değer baskılama (kalıcı hale getirme)
...
# 1. 6 aylık standartlaştırılmış CLTV'ye göre tüm müşterilerinizi 4 gruba (segmente)
# ayırınız ve grup isimlerini veri setine ekleyiniz.
...
# 3. 5 grup içerisinden seçeceğiniz 2 grup için yönetime kısa kısa 6 aylık aksiyon önerilerinde bulununuz
